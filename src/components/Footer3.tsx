  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.fastAccess}>
        ...
        <div className={styles.languageSwitcher}>
          <div className={styles.questionsSettings}>
            ...
            <div className={styles.logoCollection}>
              <img
          ...
          <div className={styles.questionsSettings1}>
            <div className={styles.questionsSettingsChild} />
      ...
      <div className={styles.language}>
        ...
        <div className={styles.chevrondownArrow}>
          <div className={styles.languageSelector} />
          <div className={styles.englishLabel}>
